...
def test_data_migration_service_client_service_account_always_use_jwt_true(transport_class, transport_name):
    with mock.patch.object(service_account.Credentials, 'with_always_use_jwt_access', create=True) as use_jwt:
        creds = service_account.Credentials(None, None, None)
...
def test_data_migration_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_list_migration_jobs(transport: str = 'grpc', request_type=clouddms.ListMigrationJobsRequest):
    client = DataMigrationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_migration_job(transport: str = 'grpc', request_type=clouddms.CreateMigrationJobRequest):
    client = DataMigrationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_migration_job(transport: str = 'grpc', request_type=clouddms.UpdateMigrationJobRequest):
    client = DataMigrationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_migration_job(transport: str = 'grpc', request_type=clouddms.DeleteMigrationJobRequest):
    client = DataMigrationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_start_migration_job(transport: str = 'grpc', request_type=clouddms.StartMigrationJobRequest):
    client = DataMigrationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_stop_migration_job(transport: str = 'grpc', request_type=clouddms.StopMigrationJobRequest):
    client = DataMigrationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_resume_migration_job(transport: str = 'grpc', request_type=clouddms.ResumeMigrationJobRequest):
    client = DataMigrationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_promote_migration_job(transport: str = 'grpc', request_type=clouddms.PromoteMigrationJobRequest):
    client = DataMigrationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_verify_migration_job(transport: str = 'grpc', request_type=clouddms.VerifyMigrationJobRequest):
    client = DataMigrationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_restart_migration_job(transport: str = 'grpc', request_type=clouddms.RestartMigrationJobRequest):
    client = DataMigrationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_generate_ssh_script(transport: str = 'grpc', request_type=clouddms.GenerateSshScriptRequest):
    client = DataMigrationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_connection_profiles(transport: str = 'grpc', request_type=clouddms.ListConnectionProfilesRequest):
    client = DataMigrationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_connection_profile(transport: str = 'grpc', request_type=clouddms.CreateConnectionProfileRequest):
    client = DataMigrationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_connection_profile(transport: str = 'grpc', request_type=clouddms.UpdateConnectionProfileRequest):
    client = DataMigrationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
