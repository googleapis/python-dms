...
from google.cloud.clouddms_v1.services.data_migration_service import DataMigrationServiceAsyncClient
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (DataMigrationServiceClient, transports.DataMigrationServiceGrpcTransport, "grpc"),
    (DataMigrationServiceAsyncClient, transports.DataMigrationServiceGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class", [
    DataMigrationServiceClient, DataMigrationServiceAsyncClient
])
@mock.patch.object(DataMigrationServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DataMigrationServiceClient))
@mock.patch.object(DataMigrationServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DataMigrationServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (DataMigrationServiceClient, transports.DataMigrationServiceGrpcTransport, "grpc", grpc_helpers),
    (DataMigrationServiceAsyncClient, transports.DataMigrationServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
])
...
def test_list_migration_jobs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, clouddms_resources.MigrationJob)
                   for i in results)
...
async def test_list_migration_jobs_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_migration_jobs(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_create_private_connection(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_private_connection),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_get_private_connection(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_private_connection),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = clouddms_resources.PrivateConnection(
            ...
            vpc_peering_config=clouddms_resources.VpcPeeringConfig(vpc_name='vpc_name_value'),
        )
...
def test_list_private_connections_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, clouddms_resources.PrivateConnection)
                   for i in results)
...
def test_delete_private_connection(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_private_connection),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_get_conversion_workspace(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_conversion_workspace),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_conversion_workspaces_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, conversionworkspace_resources.ConversionWorkspace)
                   for i in results)
...
async def test_list_conversion_workspaces_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_conversion_workspaces(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_create_conversion_workspace(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_conversion_workspace),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_conversion_workspace_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_conversion_workspace(
            parent='parent_value',
            conversion_workspace=conversionworkspace_resources.ConversionWorkspace(name='name_value'),
...
def test_update_conversion_workspace(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_conversion_workspace),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_conversion_workspace(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_conversion_workspace),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_seed_conversion_workspace(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.seed_conversion_workspace),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_import_mapping_rules(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.import_mapping_rules),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_convert_conversion_workspace(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.convert_conversion_workspace),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_commit_conversion_workspace(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.commit_conversion_workspace),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_rollback_conversion_workspace(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.rollback_conversion_workspace),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_apply_conversion_workspace(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.apply_conversion_workspace),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_describe_database_entities_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, conversionworkspace_resources.DatabaseEntity)
                   for i in results)
...
async def test_describe_database_entities_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.describe_database_entities(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_search_background_jobs(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.search_background_jobs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_describe_conversion_workspace_revisions(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.describe_conversion_workspace_revisions),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_fetch_static_ips(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.fetch_static_ips),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_data_migration_service_host_no_port(transport_name):
    client = DataMigrationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='datamigration.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'datamigration.googleapis.com:443'
...
def test_data_migration_service_host_with_port(transport_name):
    ...
    assert client.transport._host == (
        'datamigration.googleapis.com:8000'
    )
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.DataMigrationServiceGrpcTransport, transports.DataMigrationServiceGrpcAsyncIOTransport])
def test_data_migration_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
