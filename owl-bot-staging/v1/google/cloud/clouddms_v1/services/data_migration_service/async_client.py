...
from google.cloud.clouddms_v1.types import conversionworkspace_resources
...
class DataMigrationServiceAsyncClient:
    ...
    connection_profile_path = staticmethod(DataMigrationServiceClient.connection_profile_path)
    parse_connection_profile_path = staticmethod(DataMigrationServiceClient.parse_connection_profile_path)
    conversion_workspace_path = staticmethod(DataMigrationServiceClient.conversion_workspace_path)
    parse_conversion_workspace_path = staticmethod(DataMigrationServiceClient.parse_conversion_workspace_path)
    ...
    private_connection_path = staticmethod(DataMigrationServiceClient.private_connection_path)
    parse_private_connection_path = staticmethod(DataMigrationServiceClient.parse_private_connection_path)
    ...
    async def list_migration_jobs(self,
    ...
    async def get_migration_job(self,
    ...
    async def create_migration_job(self,
    ...
    async def update_migration_job(self,
    ...
    async def delete_migration_job(self,
    ...
    async def start_migration_job(self,
    ...
    async def stop_migration_job(self,
    ...
    async def resume_migration_job(self,
    ...
    async def promote_migration_job(self,
    ...
    async def verify_migration_job(self,
    ...
    async def restart_migration_job(self,
    ...
    async def generate_ssh_script(self,
    ...
    async def list_connection_profiles(self,
    ...
    async def get_connection_profile(self,
    ...
    async def create_connection_profile(self,
    ...
    async def update_connection_profile(self,
    ...
    async def delete_connection_profile(self,
    ...
    async def create_private_connection(self,
    ...
    async def get_private_connection(self,
    ...
    async def list_private_connections(self,
    ...
    async def delete_private_connection(self,
    ...
    async def get_conversion_workspace(self,
    ...
    async def list_conversion_workspaces(self,
    ...
    async def create_conversion_workspace(self,
            request: Optional[Union[clouddms.CreateConversionWorkspaceRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            conversion_workspace: Optional[conversionworkspace_resources.ConversionWorkspace] = None,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([parent, conversion_workspace, conversion_workspace_id])
        if request is not None and has_flattened_params:
            raise ValueError("If the `request` argument is set, then none of "
                             "the individual field arguments should be set.")
    ...
    async def update_conversion_workspace(self,
            request: Optional[Union[clouddms.UpdateConversionWorkspaceRequest, dict]] = None,
            *,
            conversion_workspace: Optional[conversionworkspace_resources.ConversionWorkspace] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    async def delete_conversion_workspace(self,
            request: Optional[Union[clouddms.DeleteConversionWorkspaceRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    async def seed_conversion_workspace(self,
    ...
    async def import_mapping_rules(self,
    ...
    async def convert_conversion_workspace(self,
            request: Optional[Union[clouddms.ConvertConversionWorkspaceRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
    ...
    async def commit_conversion_workspace(self,
            request: Optional[Union[clouddms.CommitConversionWorkspaceRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
    ...
    async def rollback_conversion_workspace(self,
            request: Optional[Union[clouddms.RollbackConversionWorkspaceRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
    ...
    async def apply_conversion_workspace(self,
    ...
    async def describe_database_entities(self,
    ...
    async def search_background_jobs(self,
    ...
    async def describe_conversion_workspace_revisions(self,
            request: Optional[Union[clouddms.DescribeConversionWorkspaceRevisionsRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
    ...
    async def fetch_static_ips(self,
